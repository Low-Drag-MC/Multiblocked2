...
//import com.lowdragmc.mbd2.common.gui.editor_outdatated.machine.widget.MachineStatePreview;
...
//
//    public MachineConfigPanel(MBDEditor editor, MachineProject machineProject) {
//        super(editor);
...
//            editor.getConfigPanel().openConfigurator(MBDEditor.BASIC, project.getDefinition());
//        }
//    }
//
//    /**
...
//        editor.getConfigPanel().clearAllConfigurators(MBDEditor.SECOND);
...
//        editor.getConfigPanel().openConfigurator(MBDEditor.SECOND, state);
//        if (previewMachine != null) {
