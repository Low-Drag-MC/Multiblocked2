//package com.lowdragmc.mbd2.common.gui.editor_outdatated.machine.widget;
//
...
//import com.lowdragmc.mbd2.common.gui.editor_outdatated.MachineProject;
//import com.lowdragmc.mbd2.common.gui.editor_outdatated.machine.MachineScenePanel;
...
//    private final MBDEditor editor;
//    @Nullable
//    @Getter
//    private TraitDefinition selected;
//
//    public TraitList(MBDEditor editor, Size size) {
...
//            editor.getConfigPanel().openConfigurator(MBDEditor.BASIC, definition);
//            selected = definition;
//        });
...
//                    menu.leaf(Icons.COPY, "ldlib2.gui.editor.menu.copy", () -> {
