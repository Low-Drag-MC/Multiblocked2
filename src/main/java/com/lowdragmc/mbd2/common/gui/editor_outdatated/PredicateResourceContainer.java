...
//import com.lowdragmc.mbd2.integration.LDLib2.MBDLDLibPlugin;
//import com.mojang.datafixers.util.Either;
//
//import java.io.File;
//
//public class PredicateResourceContainer extends ResourceContainer<PatternPredicate, Widget> {
//
//    public PredicateResourceContainer(Resource<PatternPredicate> resource, ResourcePanel panel) {
...
//            if (predicate == PatternPredicate.ANY || predicate == PatternPredicate.AIR) return;
...
//    }
//
//    protected ImageWidget createPreview(PatternPredicate predicate) {
...
//                    LocalizationUtils.format("ldlib2.gui.editor.tips.rename") + " " + LocalizationUtils.format(resource.name()),
