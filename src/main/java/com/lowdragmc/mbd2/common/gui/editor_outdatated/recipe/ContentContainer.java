...
//                        Editor.INSTANCE.getConfigPanel().openConfigurator(MBDEditor.SECOND, new IConfigurable() {
//                            @Override
...
//                    selected = null;
//                    if (Editor.INSTANCE != null) {
//                        Editor.INSTANCE.getConfigPanel().clearAllConfigurators(MBDEditor.SECOND);
//                    }
//                });
