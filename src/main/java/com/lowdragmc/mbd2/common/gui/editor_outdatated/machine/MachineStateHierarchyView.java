...
//import java.util.*;
//
//public class MachineStateHierarchyView extends View {
//    public record DraggingNode(MachineState draggedNode) {}
//    public final FXEditor fxEditor;
//    public final ScrollerView scrollerView = new ScrollerView();
//    public final TreeList<MachineState> treeList = new TreeList<>();
//
//    // runtime
...
//    @Getter @Nullable
//    private MachineState rootNode;
//
//    public MachineStateHierarchyView(FXEditor fxEditor) {
