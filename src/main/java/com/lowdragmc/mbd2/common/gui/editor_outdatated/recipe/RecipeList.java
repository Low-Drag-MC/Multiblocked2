...
//            selected = null;
//            recipeTypePanel.contentGroup.clearAllWidgets();
//            recipeTypePanel.editor.getConfigPanel().clearAllConfigurators(MBDEditor.SECOND);
...
//            this.recipeTypePanel.editor.getConfigPanel().clearAllConfigurators(MBDEditor.SECOND);
//            recipeTypePanel.getFloatView().clearRecipe();
//        }
//    }
//
...
//            if (selected != null) {
//                menu.crossLine();
//                menu.leaf("ldlib2.gui.editor.menu.rename", () -> {
//                    var currentID = selected.getId().toString();
//                    DialogWidget.showStringEditorDialog(this.recipeTypePanel.editor, "ldlib2.gui.editor.tips.rename", currentID,
//                            s -> true, s -> {
//                                if (s == null || !ResourceLocation.isValidPath(s)) return;
//                                var id = ResourceLocation.parse(s);
//                                var index2 = 0;
...
//                    }
//                    DialogWidget.showStringEditorDialog(this.recipeTypePanel.editor, "ldlib2.gui.editor.menu.copy", copiedID.toString(),
//                            s -> true, s -> {
//                                if (s == null || !ResourceLocation.isValidPath(s)) return;
//                                var id = ResourceLocation.parse(s);
//                                var index2 = 0;
