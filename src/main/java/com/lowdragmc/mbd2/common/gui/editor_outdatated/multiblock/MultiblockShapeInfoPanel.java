//package com.lowdragmc.mbd2.common.gui.editor_outdatated.multiblock;
//
...
//import com.lowdragmc.lowdraglib2.gui.editor.ui.MenuPanel;
...
//import com.lowdragmc.mbd2.common.gui.editor_outdatated.MultiblockMachineProject;
//import com.lowdragmc.mbd2.common.gui.editor_outdatated.multiblock.widget.ShapeInfoList;
...
//    @Getter
//    protected final MBDEditor editor;
//    @Getter
...
//
//    public MultiblockShapeInfoPanel(MBDEditor editor, MultiblockMachineProject project) {
...
//        editor.getConfigPanel().clearAllConfigurators(MBDEditor.BASIC);
//    }
//
//    public void loadShapeInfo(@Nullable IConfigurable configurable, Collection<BlockPos> blocks) {
//        scene.setRenderedCore(blocks);
//        if (configurable != null) {
//            editor.getConfigPanel().openConfigurator(MBDEditor.BASIC, configurable);
//        } else {
//            editor.getConfigPanel().clearAllConfigurators(MBDEditor.BASIC);
//        }
//    }
