...
//            @ConfigNumber(range={Integer.MIN_VALUE, Integer.MAX_VALUE}, wheel=1)
...
//        Editor.INSTANCE.getConfigPanel().openConfigurator(MBDEditor.BASIC, runtime);
//    }
//
//    /**
