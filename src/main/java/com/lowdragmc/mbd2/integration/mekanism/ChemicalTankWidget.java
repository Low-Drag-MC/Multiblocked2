...
//import com.lowdragmc.lowdraglib2.jei.JEIPlugin;
//import com.lowdragmc.lowdraglib2.side.fluid.FluidHelper;
...
//    @Getter
//    protected int tank;
//    @Configurable(name = "ldlib2.gui.editor.name.showAmount")
//    @Setter
//    protected boolean showAmount;
//    @Configurable(name = "ldlib2.gui.editor.name.allowClickFilled")
//    @Setter
//    protected boolean allowClickFilled;
//    @Configurable(name = "ldlib2.gui.editor.name.allowClickDrained")
//    @Setter
//    protected boolean allowClickDrained;
//    @Configurable(name = "ldlib2.gui.editor.name.drawHoverOverlay")
//    @Setter
//    public boolean drawHoverOverlay = true;
//    @Configurable(name = "ldlib2.gui.editor.name.drawHoverTips")
//    @Setter
//    protected boolean drawHoverTips;
//    @Configurable(name = "ldlib2.gui.editor.name.fillDirection")
//    @Setter
...
//        if (LDLib2.isModLoaded(LDLib2.MODID_JEI)) {
//            var pos = getPosition();
//            var size = getSize();
...
////        }
//        if (LDLib2.isEmiLoaded() && LDLib2.isModLoaded(LDLib2.MODID_JEI)) {
...
//            tooltips.add(Component.translatable("ldlib2.fluid.amount", lastChemicalInTank.getAmount(), lastTankCapacity).append(" mB"));
//        } else {
//            tooltips.add(Component.translatable("ldlib2.fluid.empty"));
//            tooltips.add(Component.translatable("ldlib2.fluid.amount", 0, lastTankCapacity).append(" mB"));
//        }
...
//                father.addConfigurators(new WrapperConfigurator("ldlib2.gui.editor.group.preview", new Gas() {
//                    @Override
...
//                father.addConfigurators(new WrapperConfigurator("ldlib2.gui.editor.group.preview", new Infuse() {
//                    @Override
//                    public void updateScreen() {
//                        super.updateScreen();
...
//                    father.addConfigurators(new WrapperConfigurator("ldlib2.gui.editor.group.preview", new Pigment() {
//                        @Override
//                        public void updateScreen() {
//                            super.updateScreen();
...
//                    father.addConfigurators(new WrapperConfigurator("ldlib2.gui.editor.group.preview", new Slurry() {
//                        @Override
//                        public void updateScreen() {
//                            super.updateScreen();
